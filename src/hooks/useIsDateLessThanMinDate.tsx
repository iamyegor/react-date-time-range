...
import { selectFirstDate, selectMinDate, selectSecondDate } from "../features/dateTimeRangeSlice";
...
export default function useIsDateLessThanMinDate() {
    ...
    const [isFirstDateLessThanMinDate, setIsFirstDateLessThanMinDate] = useState<boolean>(false);
    const [isSecondDateLessThanMinDate, setIsSecondDateLessThanMinDate] = useState<boolean>(false);
