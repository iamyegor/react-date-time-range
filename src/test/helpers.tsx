...
export function expectOptionsToBeEnabledInRange(
  from: number,
  to: number,
  options: HTMLElement[]
) {
...
export function getOptionsInRange(
  from: number,
  to: number,
  options: HTMLElement[]
) {
...
export function expectOptionsToBeDisabledInRange(
  from: number,
  to: number,
  options: HTMLElement[]
) {
...
export function expectSecondInputToBeInvalid() {
  const secondInputWrapper = screen.getAllByTestId(
