...
export default function OkButton({ children }: OKButtonProps) {
    ...
    function handleClick() {
        ...
        } else if (activeInput === ActiveInput.First && !areSecondDateAndTimeSelected) {
            dispatch(setActiveInput(ActiveInput.Second));
        } else if (activeInput === ActiveInput.Second && !areFirstDateAndTimeSelected) {
