...
import { hours12, hours24 } from "../../../constants.ts";
import { selectMaxTimeIn24Hours, selectMinTimeIn24Hours } from "../../../redux/dateTimeRangeSlice.ts";
import { Time } from "../../../types.tsx";

export default function useDisabledHours(selectedTime: Time | null, isAMPM: boolean) {
    ...
    useEffect(() => {
        setDisabledHours([...getDisabledHoursForMinTime(), ...getDisabledHourForMaxTime()]);
